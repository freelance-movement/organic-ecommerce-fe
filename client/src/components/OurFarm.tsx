...
const farmVideos = [
  {
    ...
    description: "Traditional rice cultivation methods passed down through generations in the fertile Mekong Delta.",
    videoUrl: "https://player.vimeo.com/video/176916362?background=1&autoplay=1&loop=1&muted=1",
    thumbnail: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
  ...
  },
  {
    ...
    description: "High-altitude tea plantations where morning mist creates the perfect environment for premium tea leaves.",
    videoUrl: "https://player.vimeo.com/video/347119375?background=1&autoplay=1&loop=1&muted=1",
    thumbnail: "https://images.unsplash.com/photo-1563822249548-9a72b6353cd1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
  ...
  },
  {
    ...
    description: "Organic fruit cultivation using sustainable farming practices that preserve soil health and biodiversity.",
    videoUrl: "https://player.vimeo.com/video/285086929?background=1&autoplay=1&loop=1&muted=1",
    thumbnail: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
  ...
  },
  {
    ...
    description: "Chemical-free vegetable farming where every crop is nurtured with care and traditional wisdom.",
...
export default function OurFarm() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-viet-earth-cream via-white to-viet-green-light/20 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Discover the authentic farming practices that make our products extraordinary
          </p>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="bg-viet-green-light/20 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-viet-green-dark">50+</div>
                    <div className="text-sm text-gray-600">Partner Farms</div>
                  </div>
                  <div className="bg-viet-earth-gold/20 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-viet-green-dark">100%</div>
